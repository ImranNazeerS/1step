  ...
  return (
    ...
    <TopLoadingBar ref={topLoadingBarRef} color="#ff9900" height={3} />
      ...
      <div className="w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8">
        ...
        <p className="font-light text-gray-500 dark:text-gray-400">We&apos;ll email you instructions to reset your password.</p>
        <div className="mt-4 space-y-4 lg:mt-5 md:space-y-5">
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3 text-sm">
              <label htmlFor="terms" className="font-light text-gray-500 dark:text-gray-300">
                I accept the <a className="font-medium text-amber-200 hover:underline dark:text-amber-400" href="#">Terms and Conditions</a>
              </label>
            </div>
          </div>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <Link
              to="/signin"
              className="mt-4 font-semibold leading-6 text-sky-200 hover:text-slate-400 transition-all duration-300 ease-in-out underline decoration-sky-500 md:mt-0"
            >
              Back to Sign in
            </Link>
        ...
        <p className="mt-5 text-red-700">{error && 'Enter a valid email address'}</p>
      </div>
    </section>
